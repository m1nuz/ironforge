...
namespace video {
    namespace gl330 {
        auto create_texture_2d(const texture_info &info) -> texture {
            ...
            game::journal::debug(game::journal::category::video, "Create 2d texture %\n", tex);
        ...
        auto create_texture_cube(const texture_info (&infos)[6]) -> texture {
            ...
            game::journal::debug(game::journal::category::video, "Create cube texture %\n", tex);
        ...
        auto destroy_texture(texture &tex) -> void {
            if (glIsTexture(tex.id)) {
                game::journal::debug(game::journal::category::video, "Delete texture %\n", tex.id);
